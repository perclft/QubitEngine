...
public:
    ...
    // --- Advanced Gates ---
    virtual void applyToffoli(size_t control1, size_t control2, size_t target) = 0;
    virtual void applyPhaseS(size_t target) = 0;
    virtual void applyPhaseT(size_t target) = 0;
    virtual void applyRotationY(size_t target, double angle) = 0;
    virtual void applyRotationZ(size_t target, double angle) = 0;

    // --- Noise ---
    virtual void applyDepolarizingNoise(double probability) = 0;
    ...
    // --- State Access ---
    virtual std::vector<std::complex<double>> getStateVector() const = 0;
