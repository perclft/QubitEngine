...
**Python Version:** 3.14.0 / 3.14.3
**Backend:** CudaBackend / CpuBackend Dual (via native extensions) / MetalBackend (GPU)
...
<details>
<summary>Raw output from MetalBackend runs</summary>

```
MetalBackend::initializeMetal - Start
MetalBackend::initializeMetal - Device Created: Apple M3
MetalBackend::initializeMetal - CommandQueue Created
MetalBackend::initializeMetal - Main Bundle Library not found, trying file...
MetalBackend::initializeMetal - Loaded from bin/default.metallib
MetalBackend::initializeMetal - Library Loaded
MetalBackend::initializeMetal - Pipelines Built
QuantumRegister: Using MetalBackend (GPU)
```
</details>

## 6. Linux Docker (CpuBackend Fallback)

**Platform:** Linux (Debian bookworm-slim Docker)
**Python Version:** 3.11.2
**Backend:** CpuBackend

### Scaling Test: State Vector Size vs Performance

| Qubits | State Size | Memory (KB) | Init Time | H Gate Time |
|--------|------------|-------------|-----------|-------------|
| 4      | 16         | 0.2         | 32.696 ms | 0.7580 ms   |
| 8      | 256        | 4.0         | 0.277 ms  | 0.0423 ms   |
| 12     | 4,096      | 64.0        | 0.133 ms  | 0.1898 ms   |
| 16     | 65,536     | 1,024.0     | 1.146 ms  | 0.1293 ms   |
| 18     | 262,144    | 4,096.0     | 4.453 ms  | 0.3382 ms   |
| 20     | 1,048,576  | 16,384.0    | 16.023 ms | 0.4320 ms   |
| 22     | 4,194,304  | 65,536.0    | 59.170 ms | 0.8696 ms   |

### Gate Throughput Test (16 qubits, 100 iterations)

| Gate       | Total Gates | Duration | Gates/sec | μs/gate |
|------------|-------------|----------|-----------|---------|
| Hadamard   | 1,600       | 0.0673 s | 23.78K    | 42.05   |
| Pauli-X    | 1,600       | 0.0660 s | 24.24K    | 41.26   |
| Pauli-Y    | 1,600       | 0.1623 s | 9.86K     | 101.42  |
| Pauli-Z    | 1,600       | 0.0754 s | 21.21K    | 47.15   |
| Rotation-Y | 1,600       | 0.0734 s | 21.81K    | 45.86   |
| Rotation-Z | 1,600       | 0.0853 s | 18.76K    | 53.31   |
| CNOT       | 1,500       | 0.0615 s | 24.40K    | 40.99   |

### Stress Test: Maximum Qubit Count

| Qubits | Amplitudes | Memory Target | Status | Init Time | Gate Time |
|--------|------------|---------------|--------|-----------|-----------|
| 20     | 1,048,576  | 0.02 GB       | [OK]   | 12.4 ms   | 0.80 ms   |
| 22     | 4,194,304  | 0.06 GB       | [OK]   | 53.5 ms   | 7.53 ms   |
| 24     | 16,777,216 | 0.25 GB       | [OK]   | 249.0 ms  | 38.10 ms  |
| 26     | 67,108,864 | 1.00 GB       | [OK]   | 938.5 ms  | 164.51 ms |
