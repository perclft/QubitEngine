...
export interface VQERequest {
    ...
    /**
     * @generated from protobuf field: qubit_engine.VQERequest.OptimizerType optimizer_type = 4
     */
...
/**
 * @generated from protobuf enum qubit_engine.VQERequest.OptimizerType
 */
export enum VQERequest_OptimizerType {
    /**
     * Simultaneous Perturbation Stochastic Approximation
     *
     * @generated from protobuf enum value: SPSA = 0;
     */
    SPSA = 0,
    /**
     * Native Differentiable Simulation (Parameter Shift)
     *
     * @generated from protobuf enum value: GRADIENT_DESCENT = 1;
     */
    GRADIENT_DESCENT = 1
}
/**
...
class VQERequest$Type extends MessageType<VQERequest> {
    constructor() {
        super("qubit_engine.VQERequest", [
            ...
            { no: 4, name: "optimizer_type", kind: "enum", T: () => ["qubit_engine.VQERequest.OptimizerType", VQERequest_OptimizerType] }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* double learning_rate */ 3:
                    ...
                    break;
                case /* qubit_engine.VQERequest.OptimizerType optimizer_type */ 4:
                    message.optimizerType = reader.int32();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: VQERequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* qubit_engine.VQERequest.OptimizerType optimizer_type = 4; */
        if (message.optimizerType !== 0)
            writer.tag(4, WireType.Varint).int32(message.optimizerType);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
