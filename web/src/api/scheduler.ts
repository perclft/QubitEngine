...
export const QuantumSchedulerService = {
  ...
  streamClusterMetrics: {
    path: "/qubit_engine.QuantumScheduler/StreamClusterMetrics" as const,
    requestStream: false as const,
    responseStream: true as const,
    requestSerialize: (value: Empty): Buffer => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value: Buffer): Empty => Empty.decode(value),
...
export interface QuantumSchedulerServer extends UntypedServiceImplementation {
  ...
  /** Stream real-time cluster metrics for visualization */
  streamClusterMetrics: handleServerStreamingCall<Empty, ClusterMetricsResponse>;
}
...
export interface QuantumSchedulerClient extends Client {
  ...
  /** Stream real-time cluster metrics for visualization */
  streamClusterMetrics(request: Empty, options?: Partial<CallOptions>): ClientReadableStream<ClusterMetricsResponse>;
  streamClusterMetrics(
    request: Empty,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
  ): ClientReadableStream<ClusterMetricsResponse>;
}
