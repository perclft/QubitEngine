...
func (x *GateStreamRequest) GetInit() *GateStreamInit {
	if x != nil {
		if x, ok := x.Msg.(*GateStreamRequest_Init); ok {
			return x.Init
		}
	}
	return nil
...
func (x *GateStreamRequest) GetOp() *GateOperation {
	if x != nil {
		if x, ok := x.Msg.(*GateStreamRequest_Op); ok {
			return x.Op
		}
	}
	return nil
...
const file_api_proto_quantum_proto_rawDesc = "" +
	...
	"\ause_shm\x18\x02 \x01(\bR\x06useShm\"}\n" +
	"\x11GateStreamRequest\x122\n" +
	"\x04init\x18\x01 \x01(\v2\x1c.qubit_engine.GateStreamInitH\x00R\x04init\x12-\n" +
	"\x02op\x18\x02 \x01(\v2\x1b.qubit_engine.GateOperationH\x00R\x02opB\x05\n" +
	"\x03msg\"\xee\x03\n" +
	"\rStateResponse\x12L\n" +
	...
	"parameters\x12\x1c\n" +
	"\tconverged\x18\x04 \x01(\bR\tconverged\"\x19\n" +
	"\x17HardwareTopologyRequest\"7\n" +
	"\tQubitNode\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\f\n" +
	"\x01x\x18\x02 \x01(\x01R\x01x\x12\f\n" +
	"\x01y\x18\x03 \x01(\x01R\x01y\"9\n" +
	"\vCouplerEdge\x12\x14\n" +
	"\x05node1\x18\x01 \x01(\x05R\x05node1\x12\x14\n" +
