...
type QuantumComputeClient interface {
	...
	StreamGates(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[GateStreamRequest, StateResponse], error)
...
func (c *quantumComputeClient) StreamGates(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[GateStreamRequest, StateResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &QuantumCompute_ServiceDesc.Streams[0], QuantumCompute_StreamGates_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GateStreamRequest, StateResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type QuantumCompute_StreamGatesClient = grpc.BidiStreamingClient[GateStreamRequest, StateResponse]
...
func (c *quantumComputeClient) GetHardwareTopology(ctx context.Context, in *HardwareTopologyRequest, opts ...grpc.CallOption) (*HardwareTopologyResponse, error) {
	...
	err := c.cc.Invoke(ctx, QuantumCompute_GetHardwareTopology_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QuantumComputeServer interface {
	...
	//
	// IMPORTANT: the first message MUST be an init message specifying num_qubits.
	StreamGates(grpc.BidiStreamingServer[GateStreamRequest, StateResponse]) error
	// Visualization method for Web (Server-Side Streaming only).
	// gRPC-Web does not support bidirectional streaming.
	// This executes a circuit and streams back the state after EACH step.
...
func (UnimplementedQuantumComputeServer) StreamGates(grpc.BidiStreamingServer[GateStreamRequest, StateResponse]) error {
...
func _QuantumCompute_StreamGates_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(QuantumComputeServer).StreamGates(&grpc.GenericServerStream[GateStreamRequest, StateResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type QuantumCompute_StreamGatesServer = grpc.BidiStreamingServer[GateStreamRequest, StateResponse]
...
func _QuantumCompute_GetHardwareTopology_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: QuantumCompute_GetHardwareTopology_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
